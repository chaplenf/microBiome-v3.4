function dy = coCulture_ode2Research3(t, y, ~)
...
uptakeRates132;  % updating FBA organism uptake constraints
...
try
    switch community.species{1,i}.description
        case 'Nitrosomonas europaea'
               community.species{1,i} = changeRxnBounds(community.species{1,i},'EX_cpd00418x_c',4.5,'u');
               community.species{1,i} = changeRxnBounds(community.species{1,i},'EX_cpd00418_e',4.5,'u');                
