function [t, V, Vg, X, L, LNM, G, AB, BB, MT, R] = Co4Research3(tspan, initialConditions)
...
nonNeg=linspace(1,151,151);
        ...
        DO=@coCulture_ode4Research3;
        options=odeset('JPattern',sparseJacobian,'NonNegative',nonNeg,'RelTol',1e-10,'AbsTol',1e-8);
